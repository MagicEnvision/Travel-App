...
const CampSite = ({backgroundImage, title, subTitle, peopleJoined} : CampProps) => {
  return (
    ...
    bg-no-repeat lg:rounded-5xl 2xl:rounded-5xl`}>
...
const Camp = () => {
  return (
    <section className=' 2xl:max-container relative flex 
        ...
        xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl'>
          <h2 className='regular-24 md:regular-32 2xl:regular-64 capitalize text-white'>
            ...
            <p className='regular-14 xl:regular-16 mt-5 text-white'>
              ...
              Inventore suscipit commodi sapiente et! Quidem minus vel
              molestias eum inventore quod. Lorem, ipsum. Lorem ipsum,
              dolor sit amet consectetur adipisicing elit. Iusto, eligendi!
            </p>
            <Image 
            src="/quote.svg"
            alt='camp-2'
